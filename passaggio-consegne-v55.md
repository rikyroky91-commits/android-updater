# Passaggio di consegne — v55 (2026-08-12)
...
**994 test passati, 407 subtest passati, 0 falliti** (954 sulla base
ricevuta → 980 → 985 → 991 → 994 nei giri successivi di questa
sessione).
...
Zip consegnato: `android-updater-fix-12ago-v55.zip` (sostituisce il
v54: stesso fix del build Docker, più il quarto giro sul nome RMX3933
e il nome scritto a mano — punti -1 e -0.5 sopra). Ricorda di
applicarlo al repository vero — vedi "IMPORTANTE per chi riprende da
qui" sopra.
